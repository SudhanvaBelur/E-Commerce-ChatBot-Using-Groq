...
def sql_chain(question):
    ...
    if len(matches)==0:
        return "LLM not able to generate a SQL query for your question"
    print(matches[0].strip())

    response = run_query(matches[0].strip())

    if response is None:
        return "Sorry, There was some problem in executing the SQL query"
...
if __name__== "__main__":
    question = "All shoes with rating higher than 4.5 and total number of reviews greater than 50"
